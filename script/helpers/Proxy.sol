...
import {
ITransparentUpgradeableProxy, TransparentUpgradeableProxy} from "openzeppelin-contracts/contracts/proxy/transparent/TransparentUpgradeableProxy.sol";
import {
...
/// it will need to be set in tests as `prank`s will not affect `msg.sender` in free functions.
    ...
    function initFbtc1Token(
        ...
        upgradeToAndCall(proxyAdmin, proxy, address(impl), abi.encodeCall(FBTC1.initialize, (fbtcAddress, fireBrdigeAddress, admin, pauser, minter, safetyCommittee)));
